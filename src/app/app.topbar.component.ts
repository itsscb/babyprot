			...
			<div class="layout-topbar-wrapper">
                <div class="layout-topbar-left">
					<div class="layout-topbar-logo-wrapper">
						<a href="#">
							<img src="assets/images/senftleben.png" alt="mirage-layout" class="logo"/>
                ...
                <div class="layout-topbar-right fadeInDown" style="margin-top: 5rem;">
					<ul class="layout-topbar-actions">
						<li #impressum class="search-item topbar-item" [ngClass]="{'active-topmenuitem': appMain.activeTopbarItem === impressum}">
							<a href="#/impressum">
								<i class="topbar-icon pi pi-briefcase"></i>
							</a>
						</li>
						
						<li #docs class="search-item topbar-item" [ngClass]="{'active-topmenuitem': appMain.activeTopbarItem === impressum}">
							<a href="#/documentation">
								<i class="topbar-icon pi pi-book"></i>
							</a>
						</li>
						
						<li #contact class="search-item topbar-item" [ngClass]="{'active-topmenuitem': appMain.activeTopbarItem === impressum}">
							<a href="#/kontakt">
								<i class="topbar-icon pi pi-at"></i>
							</a>
						</li>
						<li #home class="search-item topbar-item" [ngClass]="{'active-topmenuitem': appMain.activeTopbarItem === home}">
						<a href="/">
